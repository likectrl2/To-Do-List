...
function App() {
  ...
  const [tasks, addTask, deleteTask, changeTaskCompleted, changeTaskDescription] = useTask();
  ...
  return (
    <div className='app'>
      ...
      <Page page={page} tasks={tasks} deleteTask={deleteTask} onSubmit={onSubmit} changeTaskCompleted={changeTaskCompleted} changeTaskDescription={changeTaskDescription}/>  {/*页面*/}
    </div>
  )
}
