...
type CheckboxPara = Omit<InputHTMLAttributes<HTMLInputElement>, "type">
    ...
    return (
        <label 
            className={cn(
                ...
                { "hover:text-green-800" : !disabled },
                { "bg-green-800 text-green-800" : checked },
                "relative transition",
                className
            )}
        >
            ...
            {
                checked && 
                <svg viewBox="0 0 100 100" className={cn("h-auto aspect-square rounded-sm absolute", checked ? "text-neutral-50" : "")}>
